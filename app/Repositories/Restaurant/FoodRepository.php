...
class FoodRepository extends BaseRepository
{
    ...
    public function getUserRestaurantFoods($params)
    {
        ...
        $foods = $this->getUserRestaurantFoodsQuery($params)->with('food_categories')
            ->when(isset($params['food_category_id']), function ($query) use ($params, $table, $food_category_table) {
                ...
                })->leftJoin('food_food_category', "$table.id", 'food_food_category.food_id')->where('food_food_category.food_category_id', $params['food_category_id'])->orderby('food_food_category.sort_order','asc');
    ...
    public function getUserRestaurantFoodCount($params)
    {
        $food = $this->getUserRestaurantFoodsQuery($params)->count('id');
        return $food;
    }
    public function getUserRestaurantFoodsCustome($params)
    {
