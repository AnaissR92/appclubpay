...
class VendorController extends Controller
{
    ...
    public function settingUpdate(Request $request)
    {
        ...
        if (!empty(($request->default_food_image))) {
            $attributes['default_food_image'] = uploadFile($request->default_food_image, $path);
        }

        if (!empty(($request->default_category_image))) {
            $attributes['default_category_image'] = uploadFile($request->default_category_image, $path);
        }
    ...
    public function pusherSetting(Request $request)
    {
        ...
        return view("restaurant.settings.pusher_notification", compact('pusher_data'));
    }
