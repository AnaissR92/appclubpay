...
class MenuController extends Controller
{
    ...
    public function categoryItems($restaurant_slug, FoodCategory $foodCategory)
    {
        ...
        return view("frontend.{$theme}.foods", ['restaurant' => $restaurant, 'vendor_setting' => $vendor_setting, 'categoires' => $categoires, 'food_category' => $foodCategory, 'foods' => $foodCategory->foods, 'language' => $language, 'tables' => $restaurant->tables]);
    }
}
