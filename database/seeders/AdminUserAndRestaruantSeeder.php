...
class AdminUserAndRestaruantSeeder extends Seeder
{
    public function run()
    {
        ...
        //Create Restro type
        RestaurantType::updateOrCreate(['type' => 'Cafe']);
        RestaurantType::updateOrCreate(['type' => 'Hotel']);
        RestaurantType::updateOrCreate(['type' => 'Food Truck']);
        RestaurantType::updateOrCreate(['type' => 'Pub/Bar']);
        RestaurantType::updateOrCreate(['type' => 'Quick Service Restaurant']);
        ...
        if ($user == 0) {
            ...
            Permission::create(['name' => 'show tables']);
            Permission::create(['name' => 'add tables']);
            ...
            // create restaurants permissions
            Permission::create(['name' => 'show restaurants']);
            Permission::create(['name' => 'add restaurants']);
            ...
            Permission::create(['name' => 'add food']);
            Permission::create(['name' => 'edit food']);
            Permission::create(['name' => 'delete food']);

            Permission::create(['name' => 'show qrcode']);
            Permission::create(['name' => 'show themes']);
            Permission::create(['name' => 'show vendorsetting']);

            Permission::create(['name' => 'show feedbacks']);
            Permission::create(['name' => 'show callwaiter']);
