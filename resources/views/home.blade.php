            ...
            <div class="col-md-12">
                <div class="card card-h-100">
                    <div class="card-header">
                        {{ __('system.fields.setting_reconfigure') }}
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                @if ($restaurants_count == 0)
                                    <a class="d-block mb-2" href="{{ route('restaurant.restaurants.create') }}">
                                ...
                                @if ($categories_count == 0)
                                    <a class="d-block mb-2" href="{{ route('restaurant.food_categories.create') }}">
                                        <div class="alert alert-info alert-dismissible alert-label-icon label-arrow fade show mb-0" role="alert">
                                            <i class="mdi mdi-alert-circle-outline label-icon"></i>
                                ...
                                @if ($foods_count == 0)
                                    <a class="d-block mb-2" href="{{ route('restaurant.foods.create') }}">
                                        <div class="alert alert-info alert-dismissible alert-label-icon label-arrow fade show mb-0" role="alert">
                                            <i class="mdi mdi-alert-circle-outline label-icon"></i>
                                ...
                                @if (empty(auth()->user()->email_verified_at))
                                    <a class="d-block mb-2" href="javascript:void(0)">
                                        <div class="alert alert-info alert-dismissible alert-label-icon label-arrow fade show mb-0" role="alert">
                                            <i class="mdi mdi-alert-circle-outline label-icon"></i>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div>
                                    @if ($show_smtp)
                                        <a class="d-block mb-2" href="{{ route('restaurant.environment.setting.email') }}">
                                            <div class="alert alert-info alert-dismissible alert-label-icon label-arrow fade show mb-0" role="alert">
                                                <i class="mdi mdi-alert-circle-outline label-icon"></i>
                                    ...
                                    @if ($payment_setting_count == 0)
                                        <a class="d-block mb-2" href="{{ route('restaurant.environment.payment') }}">
                                            <div class="alert alert-info alert-dismissible alert-label-icon label-arrow fade show mb-0" role="alert">
                                                <i class="mdi mdi-alert-circle-outline label-icon"></i>
