                ...
                <table style="color: #000; width: 100%;" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="text-align: left; padding: 40px 30px;">
                            ...
                            <h3 style="font-size: 16px; font-weight: normal;margin: 0 0 10px;"><b>Name</b>: {{$email}}</h3>
                            <h3 style="font-size: 16px; font-weight: normal;margin: 0 0 10px;"><b>Subject</b>: {{$subject}}</h3>
