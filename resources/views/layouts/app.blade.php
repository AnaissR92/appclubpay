            ...
            <div class="navbar-header">
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown ">
                        ...
                        @else
                            @if(auth()->user()->restaurant!=null && isset(auth()->user()->restaurant->slug) && auth()->user()->restaurant->slug!=null)
                                <div class="dropdown d-inline-block">
                                    <a href="{{ route('frontend.restaurant', ['restaurant' => auth()->user()->restaurant->slug]) }}" target="_blank" class="btn">
                                        <i class="font-size-16 fas fa-external-link-alt ms-2 " aria-hidden="true"></i>
                                    </a>
                                </div>
                            @endif
...
{{--                        </div>--}}
                            ...
                            @if (isset($restaurants) && count($restaurants) > 0)
                                <div class="dropdown  d-inline-block ms-1">
                                    <button type="button" class="btn header-item select_store_top" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <h1 class="font-size-16 px-2 pt-2 header-item d-inline-block h-auto"><span class="fas fa-store-alt font-size-16"></span></h1>
                                    </button>
                                               ...
                                               onclick="event.preventDefault(); document.getElementById('restaurant_default_restaurant{{ $restaurant->id }}').submit();" @endif title="Set as Default">
                                                    <div class="row g-0">
                                                        <div class="col-3">
                                                            ...
                                                            @else
                                                                <h1 class="rounded-circle header-profile-user font-size-18 px-2 pt-2 text-white d-inline-block font-bold bg-primary">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="{{ route('restaurant.profile') }}"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i>
                                ...
                                @role('vendor')
                                    @if (auth()->user()->free_forever == false)
                                        <a class="dropdown-item" href="{{ route('restaurant.vendor.payment.history') }}"><i class="mdi mdi-format-list-checks font-size-16 align-middle me-1"></i>
