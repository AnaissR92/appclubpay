                        ...
                        <tr>
                            ...
                            <td>
                                @if (auth()->user()->user_type == App\Models\User::USER_TYPE_ADMIN)
                                    {{ Form::open(['route' => ['restaurant.plans.destroy', ['plan' => $plan->plan_id]], 'autocomplete' => 'off', 'class' => 'data-confirm', 'data-confirm-message' => __('system.users.are_you_sure', ['name' => $plan->name]), 'data-confirm-title' => __('system.crud.delete'), 'id' => 'delete-form_' . $plan->id, 'method' => 'delete']) }}
                                @endif

                                <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                    <a role="button" href="{{ route('restaurant.plans.edit', ['plan' => $plan->plan_id]) }}" class="btn btn-success">{{ __('system.crud.edit') }}</a>
