                    ...
                    <tr>
                        ...
                        <td>
                            @if (auth()->user()->user_type == App\Models\User::USER_TYPE_ADMIN)
                                {{ Form::open(['route' => ['restaurant.testimonials.destroy', ['testimonial' => $testimonial->testimonial_id]], 'autocomplete' => 'off', 'class' => 'data-confirm', 'data-confirm-message' => __('system.testimonial.are_you_sure'), 'data-confirm-title' => __('system.crud.delete'), 'id' => 'delete-form_' . $testimonial->id, 'method' => 'delete']) }}
                            @endif

                            <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                <a role="button" href="{{ route('restaurant.testimonials.edit', ['testimonial' => $testimonial->testimonial_id]) }}" class="btn btn-success">{{ __('system.crud.edit') }}</a>
