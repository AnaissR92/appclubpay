                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3 form-group @error('phone_number') has-danger @enderror">
                                        ...
                                        <input  onkeypress="return NumberValidate(event);" type="text" class="form-control" id="pristine-phone-valid" placeholder="{{ $lbl_phone_number }}" required value="{{ old('phone_number', $user->phone_number) }}" maxlength="50" name="phone_number" data-pristine-required-message="{{ __('validation.required', ['attribute' => strtolower($lbl_phone_number)]) }}">
                                        @error('phone_number')
                                            <div class="pristine-error text-help">{{ $message }}</div>
                                        @enderror
                                    </div>
