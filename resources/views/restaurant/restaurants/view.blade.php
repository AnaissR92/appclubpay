                    ...
                    <div class="d-flex align-items-end mt-3 mt-sm-0">
                        <div class="flex-shrink-0">
                            @if ($restaurant->logo_url != null)
                                <div class="avatar-xxl me-3 ">
                                    ...
                                    <img data-src="{{ $restaurant->logo_url }}" alt="" class="img-fluid rounded-circle d-block img-thumbnail lazyload h-120px">
                                </div>
                            @else
                                <div class="avatar-xxl me-3 d-last-end ">
                                    <h1 class="rounded-circle font-size text-white d-inline-block text-bold bg-primary text-center h-w-lh-120px">{{ $restaurant->logo_name }}
                                    </h1>
                                </div>
                            @endif
                        ...
                        <div class="flex-grow-1">
                            <div>
                                ...
                                <p class="text-muted font-size-13 mb-2 pb-2">{{ $restaurant->restaurant_type->local_name }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-auto">
                    <div class="d-flex align-items-start justify-content-end gap-2 mb-2">
                        <div>
                            ...
                            <a href="{{ route('restaurant.restaurants.index') }}" role="button" class="btn btn-secondary "><i class="me-1"></i>{{ __('system.crud.back') }}</a>
                        ...
                        <div>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a class="dropdown-item" href="{{ route('restaurant.restaurants.edit', ['restaurant' => $restaurant->id, 'back' => request()->fullurl()]) }}">{{ __('system.crud.edit') }}</a></li>
                            ...
                            <div class="text-muted">
                                <dl class="row mb-0">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <dd class="col-sm-8">{{ $restaurant->restaurant_type->local_name }}</dd>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <tr>
                                            ...
                                            @if ($restaurant->id == auth()->user()->restaurant_id || auth()->user()->user_type == App\Models\User::USER_TYPE_ADMIN)
                                                <td>
                                                    ...
                                                    <a role="button" @if (auth()->user()->id == $user->id) href="{{ route('restaurant.profile') }}"  @else href="{{ route('restaurant.staff.edit', $user->id) }}" @endif
