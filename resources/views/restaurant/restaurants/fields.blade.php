    ...
    <div class="tab-content twitter-bs-wizard-tab-content">
                        ...
                        @else
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3 form-group @error('type') has-danger @enderror">
                                    ...
                                    <select class="form-control" id="restaurant_type" name="type"
                                            data-pristine-required-message="{{__('validation.custom.select_required', ['attribute' => strtolower($lbl_restaurant_type)])}}" required>
        ...
        <div class="tab-pane" id="company-document1">
            <div>
                        ...
                        <div class="row align-items-stretch">
                            ...
                            <div class="col-md-4 form-group ">
                                ...
                                <div class="d-flex  align-items-center ">
                                    ...
                                    <input type="file" name="dark_logo" id="dark_logo" class="d-none my-preview" accept="image/*"
                                           data-pristine-accept-message="{{ __('validation.enum', ['attribute' => strtolower($lbl_logo_ligth)]) }}" data-preview='.preview-image1'>
                            ...
                            <div class="col-md-4 form-group ">
                                ...
                                <div class="d-flex  align-items-center  ">
                                    ...
                                    <input type="file" name="cover_image" id="cover_image" class="d-none my-preview" accept="image/*"
                                           data-pristine-accept-message="{{ __('validation.enum', ['attribute' => strtolower($lbl_cover_image)]) }}" data-preview='.preview-cover_image-image'>
                ...
                <ul class="pager wizard twitter-bs-wizard-pager-link">
                    <li class="previous "><a href="javascript: void(0);" class="btn btn-primary" onclick=""><i class="bx bx-chevron-left me-1"></i> {{ __('system.crud.previous') }}</a> <a
                            href="{{ request()->query->get('back', null) ?? route('restaurant.restaurants.index') }}" class="btn btn-secondary">{{ __('system.crud.cancel') }}</a></li>
                        ...
                        <div class="row justify-content-center">
                            @foreach (getAllThemes() as $theme)
                                <div class="col-xl-3 col-sm-6">
                                    <div class="card  ">
                                        <input type="radio" name="theme" value="{{ strtolower($theme['name']) }}" id="t{{ $theme['id'] }}"
                                                ...
                                                <div class="row ">
                                                    ...
                                                    @if(isset($restaurant->id) && $restaurant->id>0)
                                                        <div class="col-md-6 text-end">
                                                            <a type="button" target="_blank" class="btn btn-sm btn-secondary mb-md-2"
