                    ...
                    <div class="row">
                        ...
                        @can('add restaurants')
                            <div class="col-md-6 col-xl-6 text-end add-new-btn-parent">
                                <a href="{{ route('restaurant.restaurants.create') }}" class="btn btn-primary btn-rounded waves-effect waves-light"><i class="bx bx-plus me-1"></i> {{ __('system.crud.add_new') }}</a>
                            </div>
                        @endcan
                    </div>
                </div>
