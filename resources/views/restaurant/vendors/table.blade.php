            ...
            @forelse ($vendors as $vendor)
                @php
                    ...
                    if ($vendor->free_forever==true){
                         ...
                         if (isset($active_plan) && $active_plan->type=='onetime'){
                             $plan_title="<span class='badge bg-success font-size-12'>".trans('system.plans.onetime')."</span>";
                         }else{
                            if ($vendor->is_trial_enabled==true){
                                ...
                                if(isset($plans) && count($plans)>0){
                                    $plan_title=isset($plans[$active_plan->plan_id])?"<span class='badge bg-success font-size-12'>".$plans[$active_plan->plan_id]."</span>":"";
                                }
                            }
                         }
                    }
