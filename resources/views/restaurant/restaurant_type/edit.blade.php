@extends('layouts.app')
@section('title', __('system.restaurant_type.update.menu'))
@section('content')
    <div class="row">
        ...
        <div class="col-xl-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-mb-8 col-xl-8">
                            <h4 class="card-title">{{ __('system.restaurant_type.update.menu') }}</h4>
                            <div class="page-title-box pb-0 d-sm-flex">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">{{ __('system.restaurant_type.update.menu') }}</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                ...
                {{ Form::model($restaurantType, ['route' => ['restaurant.restaurant-type.update', $restaurantType->id], 'method' => 'put', 'files' => true, 'id' => 'pristine-valid']) }}
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @include('restaurant.restaurant_type.fields', ['edit' => true])
                        </div>
                    </div>
                </div>
                <div class="card-footer bg-transparent border-top text-muted">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="{{ route('restaurant.restaurant-type.index') }}"class="btn btn-secondary">{{ __('system.crud.back') }}</a>
                        </div>
                    </div>
                </div>
                {{ Form::close() }}
