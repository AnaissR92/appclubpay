    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-sm-12">
            <div class="card">
                ...
                <form autocomplete="off" novalidate="" action="{{ route('restaurant.environment.setting.seo.update') }}" id="pristine-valid" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- Nav tabs -->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <input required value="{{ old('seo_keyword',$seo_keyword??'')}}" type="text" name="seo_keyword" class="form-control" placeholder="{{ trans('system.environment.seo_keyword') }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-5 mb-2">
                                                <div class="form-group">
                                                    <label class="text-label">{{ trans('system.environment.seo_description') }}</label>
                                                    <textarea required rows="2" type="text" name="seo_description" class="form-control" placeholder="{{ trans('system.environment.seo_description') }}">{{ old('seo_description',$seo_description??"") }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
