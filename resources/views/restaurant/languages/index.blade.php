                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xl-6 text-end add-new-btn-parent">
                            ...
                            <a href="{{ route('restaurant.languages.create') }}" class="btn btn-primary btn-rounded waves-effect waves-light"><i class="bx bx-plus me-1"></i>{{ __('system.crud.add_new') }}</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <a href="{{ route('restaurant.languages.export.sample') }}">{{ __('system.crud.download') }}</a>
                            </div>
                ...
                <div class="modal fade" id="import" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('restaurant.languages.import.sample') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="recipient-name" class="col-form-label">{{ __('system.crud.upload_excel') }}</label>
